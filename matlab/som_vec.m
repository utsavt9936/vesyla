...
%info_f_reg_0(INDEX_BETA) = info_f_reg_0(INDEX_BETA) + 1; % DPU [0,0]
%info_reg_0(INDEX_SHIFT_CONST) = info_reg_0(INDEX_SHIFT_CONST) + 8; % DPU [0,0]

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%info_reg_0(INDEX_CURR_LOCAL_BEST_LOC) = info_reg_0(INDEX_CURR_LOCAL_BEST_LOC) + 0; % DPU [0,0]
%info_f_reg_0(INDEX_CURR_LOCAL_BEST_VAL) = info_f_reg_0(INDEX_CURR_LOCAL_BEST_VAL) + 127; %! DPU[0,0]
%info_reg_0(INDEX_CURR_LOC) = info_reg_0(INDEX_CURR_LOC) + 0; %! DPU[0,0]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%i_reg_0 = i_sram_0(1:NUM_WEIGHT);
for i=1:NUM_NEURON_PER_COL
%	w_reg_0 = w_sram_0(i*NUM_WEIGHT-NUM_WEIGHT+1:i*NUM_WEIGHT);
	info_f_reg_0(INDEX_CURR_VAL) = sum(abs(w_reg_0 - i_reg_0)); %! DPU[1,0]
