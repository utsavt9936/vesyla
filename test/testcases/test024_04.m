...
% Features:
%  - Using several Load constant operations
...
result(2) = fi(0.2, 1, 8, 7, 'RoundingMethod', 'Floor');  %! DPU [0,0]
result(3) = fi(0.6, 1, 8, 7, 'RoundingMethod', 'Floor');  %! DPU [0,0]
result(4) = fi(0.99, 1, 8, 7, 'RoundingMethod', 'Floor'); %! DPU [0,0]
